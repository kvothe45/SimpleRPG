        ...
        public static GameCharacter PreMadeEnemies(GameCharacter enemy, GameCharacter fighter, int enemySelect)
        {
            ...
            switch (enemySelect)
            {
                case 1:
                    ...
                    enemy.CharacterInfo["SpecialMove"] = "Jody throws a tantrum and slaps you with all of his might.\nYes, this IS Jody's 'special' attack!";
                    break;
                case 2:
                    ...
                    enemy.CharacterInfo["SpecialMove"] = "Macho Dan finds a turnbuckle in the arena and jumps off of it,\nperforming a crushing elbow drop that would have made Randy Savage proud.";
                    break;
                case 3:
                    ...
                    enemy.CharacterInfo["TagLineTough"] = "Que te rompo!\nsubtitle: I must break you!";
                    enemy.CharacterInfo["TagLineSoft"] = "Se me rompe.\nsubtitle: You must break me";
                    enemy.CharacterInfo["Description"] = "Andrés no se siente bien. Estuvo en una fiesta anoche y llegó a casa a las 3 am.\n Tiene dolor de cabeza y siente náusea. Bebió mucho y comió demasiados camarones. ";
                    enemy.CharacterInfo["SpecialMove"] = "Fuego unleashes a blindingly fast flurry of stabs and jabs,\nthat turns your torso into swiss cheese";
                    break;
                case 4:
